...
<article class="font-body text-slate-800 dark:text-slate-200 mt-8 mb-20 space-y-16">
  ...
  <div class="max-w-3xl mx-auto space-y-8">
    ...
    <div class="mt-8">
      <a href="https://wa.me/573104499645?text=Hello%20Dr.%20Jonathan%2C%20I%20would%20like%20to%20schedule%20a%20consultation%20for%20abdominal%20thread%20lifts" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center px-8 py-4 text-base font-medium text-white bg-primary rounded-full shadow-lg hover:bg-primary/90 hover:-translate-y-1 transition-all duration-300">
