...
export default function HilosTensoresPage() {
  ...
  const content = {
    es: {
      ...
      introP2: 'El',
      introP2Strong: 'Dr. Jonathan Rincón, médico especialista referente en hilos tensores en Medellín y Bogotá',
    ...
    en: {
      ...
      introP2: 'Dr.',
      introP2Strong: 'Jonathan Rincón, recognized as a benchmark medical specialist in thread lifts in Medellín and Bogotá',
