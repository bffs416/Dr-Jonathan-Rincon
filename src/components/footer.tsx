        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              <strong className="text-primary font-semibold">Especialista #1 en hilos tensores faciales y corporales en Medellín.</strong> Tratamientos estéticos avanzados con tecnología de vanguardia y resultados garantizados.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li><Link href="/#sobre-el-doctor" className="text-muted-foreground hover:text-primary">Sobre Mi</Link></li>
