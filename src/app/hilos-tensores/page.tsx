  ...
  const faqs = [
   ...
   const beforeAfterCases = [
    ...
    },
    {
      ...
      description: 'Hilos lisos para patas de gallo, ojeras y el ovalo facial.',
      sessions: '1 sesiones',
    ...
    },
    {
      ...
      description: 'Rectificación de dorso nasal.',
      sessions: '1 sesiones',
      image: findImage('arms-combined'),
    },
    {
      title: 'Correccion de ombligo triste',
      description: 'lifting para mejorar el aspecto del ombligo triste.',
      sessions: '1 sesiones',
      image: findImage('thighs-combined'),
    },
    {
      title: 'Hilos en surcos nasogenianos',
      description: 'Relleno con hilos en los surcos para disminuir las lineas de marioneta .',
      sessions: '1 sesiones',
