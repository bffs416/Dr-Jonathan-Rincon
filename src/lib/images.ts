...
export const IMAGES: SiteImage[] = [
  // Hilos Tensores Page
  { id: 'hilos-hero', src: '/images/lifting-cuello.png', hint: 'aesthetic clinic' },
  { id: 'hilos-what-are', src: '/images/rejuvenecimiento-facial.png', hint: 'facial treatment' },
  ...
  { id: 'neck-before', src: '/images/neck-before.png', hint: 'neck lift before' },
  { id: 'neck-after', src: '/images/neck-after.png', hint: 'neck lift after' },
  { id: 'eyes-before', src: '/images/eyes-before.png', hint: 'eye rejuvenation before' },
  { id: 'eyes-after', src: '/images/eyes-after.png', hint: 'eye rejuvenation after' },
  { id: 'jawline-before', src: '/images/jawline-before.png', hint: 'jawline before' },
  { id: 'jawline-after', src: '/images/jawline-after.png', hint: 'jawline after' },
  { id: 'foxy-before', src: '/images/foxy-before.png', hint: 'fox eyes before' },
  { id: 'foxy-after', src: '/images/Hilos_Foxy_eyes.png', hint: 'fox eyes after' },
  { id: 'rhino-before', src: '/images/rhino-before.png', hint: 'rhino before' },
  { id: 'rhino-after', src: '/images/rhino-after.png', hint: 'rhino after' },
  { id: 'marionette-before', src: '/images/marionette-before.png', hint: 'marionette lines before' },
  { id: 'marionette-after', src: '/images/marionette-after.png', hint: 'marionette lines after' },
  { id: 'glutes-before', src: '/images/glutes-before.png', hint: 'butt lift before' },
  { id: 'glutes-after', src: '/images/glutes-after.png', hint: 'butt lift after' },
  { id: 'abs-before', src: '/images/abs-before.png', hint: 'abs definition before' },
  { id: 'abs-after', src: '/images/abs-after.png', hint: 'abs definition after' },
  { id: 'arms-before', src: '/images/arms-before.png', hint: 'arm lift before' },
  { id: 'arms-after', src: '/images/arms-after.png', hint: 'arm lift after' },
  { id: 'thighs-before', src: '/images/thighs-before.png', hint: 'thigh lift before' },
  { id: 'thighs-after', src: '/images/thighs-after.png', hint: 'thigh lift after' },
  { id: 'knees-before', src: '/images/knees-before.png', hint: 'knee rejuvenation before' },
  { id: 'knees-after', src: '/images/knees-after.png', hint: 'knee rejuvenation after' },
  ...
  { id: 'gallery-1', src: '/images/lifting-cuello.png', hint: 'facial procedure', title: 'Lifting de Cuello', href: '/hilos-tensores', category: 'Hilos Tensores' },
  { id: 'gallery-2', src: '/images/rejuvenecimiento-facial.png', hint: 'man consultation', title: 'Rejuvenecimiento Facial', href: '/medicina-preventiva' },
  { id: 'gallery-3', src: '/images/marcacion-mandibular.png', hint: 'facial marking', title: 'Marcación Mandibular', href: '/hilos-tensores', category: 'Hilos Tensores' },
