  ...
  const threadTypes = [
    {
      ...
      description:
        'Ideales para crear una malla de soporte que redensifica la piel. Estimulan el colágeno para mejorar la textura y dar un aspecto más turgente.',
      ...
      <div className="container mx-auto px-4 py-16 sm:py-24 space-y-24">
        ...
        >
          <div>
            ...
            <p className="mt-6 text-lg text-muted-foreground">
              ...
              , ese deseo es una realidad.
            </p>
            <p className="mt-4 text-lg text-muted-foreground">
              <strong className="text-primary font-bold">
                El Dr. Jhonathan Rincón, reconocido como el experto #1 en hilos
                tensores de Medellín
              </strong>
              , te ofrece una solución innovadora y mínimamente invasiva para
              revitalizar tu apariencia facial y corporal, con resultados que
              te encantarán.
            </p>
            <Dialog>
        ...
        <section id="aplicaciones" className="scroll-mt-20 text-center">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-lg text-muted-foreground">
            ...
            del cuerpo con resultados espectaculares.
          </p>
          ...
          <Card className="relative overflow-hidden shadow-xl md:grid md:grid-cols-2 items-center">
            <div className="p-8 md:p-12">
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                ...
                tratamiento a tu medida que cumpla tus expectativas.
              </p>
              <Button
                asChild
                size="lg"
